...
function LEDBackpack(address, bus){
  ...
  this.wire.writeBytes(__HT16K33_REGISTER_SYSTEM_SETUP | 0x01, [0x00], function(){})
...
LEDBackpack.prototype.setBrightness = function(brightness){
  ...
  this.wire.writeBytes(__HT16K33_REGISTER_DIMMING | brightness, [0x00], function(){})
}
...
LEDBackpack.prototype.setBlinkRate = function(blinkRate){
  ...
  this.wire.writeBytes(__HT16K33_REGISTER_DISPLAY_SETUP | 0x01 | (blinkRate << 1), [0x00], function(){})
}
